...
(function (root) {
  ...
  var JOB_CADENCE_MS = {
    ...
    // WARROOM-RUNSTATE-001 BUILDER self-check fixture only (2026-08-25) -- namespaced like
    // the pre-existing 'runlog-selftest-*' rows already in sasmaster.ops.run_log (see
    // WARROOM-HEALTH-001/RUNLOG_PHASE4 selftests). Not a real production job; cadence is a
    // fixture value chosen to make the watchdog/staleness self-check assertions provable
    // against live MotherDuck data without waiting on a real fleet job's natural cadence.
    'runlog-selftest-stuck-runstate001': { cadence_ms: 3600000, source: 'BUILDER self-check fixture, WARROOM-RUNSTATE-001 remediation pass' },
  };
