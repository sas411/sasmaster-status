...
function buildS3Lake(scrapers, s3Inv, entityCounts, s3Freshness) {
  ...
  const META = {
    ...
    'gracenote/':    { label: 'gracenote/',         phase: '2a', status_hint: 'live', entities_note: '47,862 unique series (PARENT_KEY3)' },
    'fyi/':          { label: 'fyi/',               phase: '2a', status_hint: 'live', entities_note: '86,001 titles · 32,712 crosswalk' },
